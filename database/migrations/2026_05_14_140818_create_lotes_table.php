...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('lotes', function (Blueprint $table) {
            ...
            $table->decimal('cantidad_inicial', 15, 4);
            $table->decimal('cantidad_actual', 15, 4);
        ...
        DB::statement('
            ALTER TABLE lotes ADD CONSTRAINT chk_lote_origen
            CHECK (
                (presentacion_id IS NOT NULL AND producto_id IS NULL)
                OR (presentacion_id IS NULL AND producto_id IS NOT NULL)
            )
        ');
